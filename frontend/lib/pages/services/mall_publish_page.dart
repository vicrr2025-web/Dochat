...
class MallPublishPage extends StatefulWidget {
  const MallPublishPage({super.key});

  @override
  State<MallPublishPage> createState() => _MallPublishPageState();
}

class _MallPublishPageState extends State<MallPublishPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        middle: Text(l10n.publishProduct),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      onTap: () {
                        setState(() => _images.add('placeholder_image'));
                      },
                      child: Container(
                        width: 80,
                        height: 80,
